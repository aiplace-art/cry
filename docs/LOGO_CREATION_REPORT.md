...
**Файлы:**
- `website/logo-hypeai.svg` (14KB)
- `website/logo-hypeai-compact.svg` (5KB)
- `website/logo-animated.html` (полностью анимированная демо)
...
**Файл:** `website/logo-animated.html` (полная интерактивная демо)
...
<!-- После -->
<div class="logo">
    <img src="logo-hypeai-compact.svg" alt="HypeAI Logo"
...
- Favicon: logo-hypeai-compact.svg
- Header: logo-hypeai-compact.svg (50×50)
...
### Основной логотип (logo-hypeai.svg):
- Размер: 500×500px
