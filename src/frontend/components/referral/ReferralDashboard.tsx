...
export const ReferralDashboard: React.FC<ReferralDashboardProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-bnb-secondary600 to-pink-600 rounded-2xl p-8 text-white">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 mt-1">Keep referring to unlock higher rewards!</p>
            </div>
            <div className={`px-6 py-3 rounded-full bg-gradient-to-r ${getLevelColor(stats.level)} text-white text-xl font-bold shadow-lg`}>
              {stats.level}
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-bnb-secondary50 to-pink-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-3">Current Benefits</h3>
            ...
            {stats.milestoneRewards > 0 && (
              <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl p-6 border-2 border-yellow-400">
                <h3 className="font-bold text-gray-900 mb-3">Milestone Rewards!</h3>
                <div className="flex items-center justify-between mb-4">
                  <span className="text-gray-700">Pending Bonus:</span>
                  <span className="text-2xl font-bold text-yellow-600">
                    {formatCurrency(stats.milestoneRewards)}
                  </span>
                </div>
                <button className="w-full px-4 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-lg font-medium hover:shadow-lg transition-all">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* Total Referrals */}
        <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-bnb-border0">
          <div className="flex items-center justify-between">
            <div>
            ...
            <div className="bg-bnb-primary/10 p-3 rounded-full">
              <svg className="w-8 h-8 text-bnb-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-bnb-border0">
          <div className="flex items-center justify-between">
            ...
            <div className="bg-bnb-secondary/10 p-3 rounded-full">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={handleCopy}
                  className="px-6 py-3 bg-gradient-to-r from-bnb-secondary600 to-pink-600 text-white rounded-lg hover:shadow-lg transition-all"
                >
                  {copied ? 'Copied!' : 'Copy'}
                </button>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              <div className="text-center p-4 bg-bnb-primary/5 rounded-lg">
                <p className="text-sm text-gray-600">Clicks</p>
                <p className="text-2xl font-bold text-bnb-primary">{formatNumber(link?.clicks || 0)}</p>
              </div>
            ...
            {link && link.conversions > 0 && (
              <div className="p-4 bg-bnb-secondary/5 rounded-lg">
                <p className="text-sm text-gray-600">Conversion Rate</p>
                <p className="text-2xl font-bold text-bnb-secondary">
          ...
          <div className="flex flex-col items-center justify-center space-y-4">
            {showQR && qrCodeUrl ? (
              <>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-6 py-2 bg-bnb-primary text-white rounded-lg hover:bg-bnb-dark transition-all"
                  >
                    Download QR
                  </button>
                  <button
              ...
              <button
                ...
                className="px-8 py-4 bg-gradient-to-r from-bnb-secondary600 to-pink-600 text-white rounded-xl hover:shadow-lg transition-all flex items-center gap-2"
              >
      ...
      {/* Quick Tips */}
      <div className="bg-gradient-to-r from-bnb-primary50 to-bnb-primary50 rounded-2xl p-8">
